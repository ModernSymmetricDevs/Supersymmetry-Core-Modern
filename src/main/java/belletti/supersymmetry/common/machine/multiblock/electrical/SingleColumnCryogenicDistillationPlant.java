...
public class SingleColumnCryogenicDistillationPlant extends WorkableElectricMultiblockMachine implements ICryogenicProvider, IExplosionMachine {
    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(SingleColumnCryogenicDistillationPlant.class,
    ...
    public SingleColumnCryogenicDistillationPlant(IMachineBlockEntity holder, Object... args) {
        super(holder, args);
    }
    ...
    public BlockPattern getPattern() {
        return FactoryBlockPattern.start(RIGHT, BACK, UP)
                ...
                .where('E', Predicates.blocks(GTBlocks.CASING_ALUMINIUM_FROSTPROOF.get())
                        .or(Predicates.ability(PartAbility.PASSTHROUGH_HATCH)))
