...
public class GroovySuSyMaterials {
    // Element Materials
    ...
    public static void changeFormulas() {
        Supersymmetry.LOGGER.info("Changing Formulas!");
        Phosphorus.setFormula("P4", true);
    }

    public static void init() {
        GroovyElementMaterials.register();
        GroovyIsotopeMaterials.register();
        GroovyUnknownCompositionMaterials.register();
        GroovyOreMaterials.register();
        GroovySuSyFirstDegreeMaterials.register();
        GroovySecondDegreeMaterials.register();
        GroovyOrganicChemistryMaterials.register();
        GroovyPetrochemistryMaterials.register();
        GroovyThirdDegreeMaterials.register();
        GroovyThermodynamicsMaterials.register();
        changeFormulas();
    }
}
